...
| # | Document | Purpose |
|---|----------|--------|
| 1 | [01-VISION-AND-SCOPE.md](./01-VISION-AND-SCOPE.md) | Product vision, product modes, lanes, MVP scope, non-goals |
| 2 | [02-SYSTEM-ARCHITECTURE.md](./02-SYSTEM-ARCHITECTURE.md) | High-level system design, services, data flow, deployment |
| 3 | [03-TECH-STACK.md](./03-TECH-STACK.md) | Technologies, versions, rationale, 2025–2026 best practices |
| 4 | [04-AUDIO-ENGINE.md](./04-AUDIO-ENGINE.md) | Web Audio, AudioWorklets, patch graph, actions, reversibility |
| 5 | [05-AGENT-SYSTEM.md](./05-AGENT-SYSTEM.md) | Agent types, Plan → Propose → Preview → Apply, outputs |
| 6 | [06-DATA-MODELS-AND-API.md](./06-DATA-MODELS-AND-API.md) | Schemas, API design, persistence, export formats |
| 7 | [07-FRONTEND-AND-UX.md](./07-FRONTEND-AND-UX.md) | UI layout, Action Timeline, Why panel, mixer, diff preview |
| 8 | [08-MVP-IMPLEMENTATION.md](./08-MVP-IMPLEMENTATION.md) | MVP build order, acceptance criteria, milestones |
| — | [ADR-TEMPLATE.md](./ADR-TEMPLATE.md) | How to record architecture changes (ADRs) |
| ★ | [RUN-IN-BROWSER.md](./RUN-IN-BROWSER.md) | Run and build 100% in the browser (no installs) |
...
1. Read **01-VISION-AND-SCOPE.md** to internalize product modes and lanes.
2. Read **03-TECH-STACK.md** and set up the repo and tooling.
3. Implement **04-AUDIO-ENGINE.md** (patch graph + Web Audio) so playback and ops work.
4. Implement **05-AGENT-SYSTEM.md** (or stub agents) and **06-DATA-MODELS-AND-API.md** (ops schema, session schema).
5. Build UI per **07-FRONTEND-AND-UX.md** and wire to session + Action Timeline.
6. Execute **08-MVP-IMPLEMENTATION.md** in the prescribed order and validate acceptance criteria.
